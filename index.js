...
const PARTIES_URI = "https://fsa-crud-2aa9294fe819.herokuapp.com/api/2308-ACC-PT-WEB-PT-A/events"
...
const getParties = async () => {
    try {
        const response = await fetch(PARTIES_URI);
...
const deleteParty = async (id) => {
    try {
        const response = await fetch(PARTIES_URI+"/"+id, {method: "DELETE"});
